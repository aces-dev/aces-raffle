...
After the raffle, we reveal the “master_seed”, “raffle_id”, and “nonce”. So anyone can recompute raffle_seed = SHA256(master_seed + raffle_id + nonce), rebuild the hash chain, and validate all winners.
